      ...
      <Route element={<ProtectedRoutes />}>
        <Route path="" element={<Layout />}>
          ...
          {isAdmin() && (
            <Route
              path="vehicles/add"
              element={<VehicleItemNew state={"new"} />}
            />
          )}
          {isAdmin() && (
            <Route
              path="vehicles/edit/:vehicleId"
              element={<VehicleItemNew state={"edit"} />}
            />
          )}
          ...
          {isAdmin() && (
            <Route
              path="drivers/add"
              element={<DriverItemNew state={"new"} />}
            />
          )}
          {isAdmin() && (
            <Route
              path="drivers/edit/:driverId"
              element={<DriverItemNew state={"edit"} />}
            />
          )}

          {isAdmin() && <Route path="companies" element={<Companies />} />}
          {isAdmin() && (
            <Route path="companies/:companyId" element={<CompanyItem />} />
          )}
          {isAdmin() && (
            <Route
              path="companies/add"
              element={<CompanyItemNew state={"new"} />}
            />
          )}
          {isAdmin() && (
            <Route
              path="companies/edit/:companyId"
              element={<CompanyItemNew state={"edit"} />}
            />
          )}
          ...
          {isAdmin() && (
            <Route
              path="bins/edit/:binId"
              element={<BinItemNew state={"edit"} />}
            />
          )}
