            ...
            >
              ...
              <Breadcrumbs maxItems={3} aria-label="breadcrumb" sx={{ mt: 1 }}>
                ...
                <Typography color="text.primary">
                  {state === "new" ? `${t("bins.add")}` : `ID: ${binItem.id}`}
                </Typography>
              </Breadcrumbs>
            </Typography>
          ...
          >
            <Paper sx={{ mt: 3, p: 2, flexGrow: 1, maxWidth: 1200 }}>
              <Box sx={{ width: "100%", mt: 2 }}>
                ...
                {((binItem?.company?.[0]?.id && state === "edit") ||
                  state === "new") && (
                  <FormControl
                    fullWidth
                    sx={{
                  ...
                  >
                    <InputLabel id="outlined-basic">
                      {t("bins.table.companyId")}
                    </InputLabel>
                    <Select
                      labelId="outlined-basic"
                      id="outlined-basic"
                      value={binItem.companyId || binItem?.company?.[0]?.id}
                ...
                <TextField
                  id="outlined-basic"
                  label={t("bins.table.address")}
                  variant="outlined"
                  sx={{ width: "100%", mb: 2, mt: 1 }}
                  value={binItem.address}
                  onChange={handleInputChange}
                  name="address"
                />
                <TextField
                  id="outlined-basic"
                  label={t("bins.table.height")}
                  variant="outlined"
                  sx={{ width: "100%", mb: 2, mt: 1 }}
                  value={binItem.height}
                  onChange={handleInputChange}
                  name="height"
                />
                <TextField
                  id="outlined-basic"
                  label={t("bins.table.length")}
                  variant="outlined"
                  sx={{ width: "100%", mb: 2, mt: 1 }}
                  value={binItem?.length}
                  onChange={handleInputChange}
                  name="length"
                />
                <TextField
                  id="outlined-basic"
                  label={t("bins.table.width")}
                  variant="outlined"
                  sx={{ width: "100%", mb: 2, mt: 1 }}
                  value={binItem.width}
                  onChange={handleInputChange}
                ...
                <TextField
                  id="outlined-basic"
                  label={t("bins.table.maxWeight")}
                  variant="outlined"
                  sx={{ width: "100%", mb: 2, mt: 1 }}
                  value={binItem.maxWeight}
                  onChange={handleInputChange}
                  name="maxWeight"
                />
                <TextField
                  id="outlined-basic"
                  label={t("bins.table.color")}
                  variant="outlined"
                  sx={{ width: "100%", mb: 2, mt: 1 }}
                  value={binItem.color}
                  onChange={handleInputChange}
                ...
                <TextField
                  id="outlined-basic"
                  label={t("bins.table.material")}
                  variant="outlined"
                  sx={{ width: "100%", mb: 2, mt: 1 }}
                  value={binItem.material}
                  onChange={handleInputChange}
                  name="material"
                />
                <TextField
                  id="outlined-basic"
                  label={t("bins.table.brand")}
                  variant="outlined"
                  sx={{ width: "100%", mb: 2, mt: 1 }}
                  value={binItem.brand}
                  onChange={handleInputChange}
            ...
            >
              <Paper sx={{ width: "100%", my: 1, p: 2, pt: 4 }}>
                ...
                <TextField
                  id="outlined-basic"
                  label={t("bins.table.latitude")}
                  variant="outlined"
                  sx={{ width: "100%", mb: 2, mt: 1 }}
                  value={binItem.latitude}
                  onChange={handleInputChange}
                  name="latitude"
                />
                <TextField
                  id="outlined-basic"
                  label={t("bins.table.longitude")}
                  variant="outlined"
                  sx={{ width: "100%", mb: 2 }}
                  value={binItem.longitude}
                  onChange={handleInputChange}
                  name="longitude"
                />
